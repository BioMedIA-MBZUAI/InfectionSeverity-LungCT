"""
Base Source: https://github.com/kenshohara/3D-ResNets-PyTorch
"""
...
def densenet(params: dict, **kwargs):
    try:
        return generate_model(params["model_depth"], **kwargs)
    except KeyError as k_error:
        raise ValueError("Model parameters are missing.") from k_error
